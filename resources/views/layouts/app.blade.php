							  ...
							  <div class="row ">
								<div class="col-12">
								  <div class="fblog_img img">
									<a href="blog-details.html"><img src="{{asset('frontend/assets/images/f1.jpg')}}" class="w-100" alt=""></a>
								  </div>
								</div>
								<div class="col-12">
			  ...
			  <div class="row border-bottom justify-content-center">
				...
				<div class="col-xl-2 col-lg-2 col-md-6 col-6 mb-4">
				  <div class="footer_content">
					...
					<ul>
					  ...
					  <li><a href="campaign.html"><i class="fa-solid fa-angles-right"></i> New Campaign</a></li>
					  <li><a href="blog-details.html"><i class="fa-solid fa-angles-right"></i> Latest News</a></li>
				...
				<div class="col-xl-2 col-lg-2 col-md-6 col-6 mb-4">
				  <div class="footer_content">
					<h5>Our Services</h5>
					<ul>
					  <li><a href="donate.html"><i class="fa-solid fa-angles-right"></i> Blood Donation</a></li>
					  <li><a href="#"><i class="fa-solid fa-angles-right"></i> Health Check</a></li>
					  <li><a href="donate.html"><i class="fa-solid fa-angles-right"></i> Blood Bank</a></li>
					  <li><a href="donate.html"><i class="fa-solid fa-angles-right"></i> Donate Process</a></li>
					  <li><a href="donate.html"><i class="fa-solid fa-angles-right"></i> Blood Info</a></li>
					</ul>
				  </div>
				</div>
					...
					<div class="footer_blog">
					  <div class="fblog_item mb-3">
						<div class="row align-items-center">
						  <div class="col-4">
							<div class="fblog_img img">
							  <a href="blog-details.html"><img src="{{asset('frontend/assets/images/f1.jpg')}}" alt=""></a>
							</div>
						  </div>
						  <div class="col-8">
							<div class="fblog_content">
					  ...
					  <div class="fblog_item mb-3">
						<div class="row align-items-center">
						  <div class="col-4">
							<div class="fblog_img img">
							  <a href="blog-details.html"><img src="{{asset('frontend/assets/images/f2.jpg')}}" alt=""></a>
							</div>
						  </div>
						  <div class="col-8">
							<div class="fblog_content">
		...
		<div class="offcanvas offcanvas-start" id="offcanvas-mobile">
		  <div class="offcanvas-body">
			<div class="mobile-menu">
			  <a href="index-2.html" class="logo py-3"><img src="{{asset('frontend/assets/images/icon/red-logo.png')}}" alt="logo"
				  class="img-fluid"></a>
		...
		<div class="offcanvas offcanvas-end right_canvas" tabindex="-1" id="offcanvasRight">
		  ...
		  <div class="offcanvas-body">
			...
			<div class="offcanvus-gallery d-flex align-items-center flex-wrap">
			  <a class="img" href="#"><img src="{{asset('frontend/assets/images/r1.jpg" alt="not found')}}"></a>
			  <a class="img" href="#"><img src="{{asset('frontend/assets/images/r2.jpg')}}" alt="not found"></a>
			  <a class="img" href="#"><img src="{{asset('frontend/assets/images/r1.jpg')}}" alt="not found"></a>
			  <a class="img" href="#"><img src="{{asset('frontend/assets/images/r3.jpg')}}" alt="not found"></a>
			  <a class="img" href="#"><img src="{{asset('frontend/assets/images/r1.jpg')}}" alt="not found"></a>
			  <a class="img" href="#"><img src="{{asset('frontend/assets/images/r2.jpg')}}" alt="not found"></a>
			</div>
