          ...
          <div class="col-lg-4 col-md-7">
            <div class="card border-0 mb-0">
              <div class="card-header bg-transparent">
                <h5 class="text-dark text-center mt-2 mb-3">Company Register  Now</h5>
                
              </div>
              <div class="card-body px-lg-5 pt-0">
              @include('partial.formerror')
                <form role="form" class="text-start" enctype="multipart/form-data" method="post" action="{{ route('companyRegister') }}">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                      <input type="text" class="form-control  @error('company_name') is-invalid @enderror" value="{{ old('company_name') }}" required  name="company_name" placeholder="Your Company Name" aria-label="Company Name" autocomplete="company_name" autofocus>
                  </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <input type="number" class="form-control  @error('zip_code') is-invalid @enderror" value="{{ old('zip_code') }}" required  name="zip_code" placeholder="Zip Code" aria-label="Zip Code">
                      </div>
                    <div class="mb-3">
