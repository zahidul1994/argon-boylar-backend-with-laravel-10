    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-8">
        <div class="km__form__box">
            {!! Form::model($profile, ['method' => 'PATCH','route' => ['profileUpdate',
            $profile->id]]) !!}
            @csrf
            <div class="row align-items-center mb-20">
              ...
              <div class="col-md">
                ...
                <input type="text" value="{{@$profile->name?: old('name') }}" required name="name" placeholder="Full Name">
              </div>
            ...
            <div class="row align-items-center mb-20">
              ...
              <div class="col-md">
                ...
                <input type="email" value="{{@$profile->email?: old('email') }}" required name="email" placeholder="Email Address">
              </div>
            ...
            <div class="col-md-6">
              <input type="date" value="{{@$profile->date_of_birth?: old('date_of_birth') }}" required name="date_of_birth"
            ...
            <div class="row align-items-center mb-10 g-4">
              <div class="col-md-3">
                <label for="profile_visibility" class="fss-18">Profile  Visibility (As Donner)<span>*</span></label>
              </div>
              <div class="col-md-9">
                {!! Form::select('profile_visibility',['0'=>'No','1'=>'Yes'],null,['id'=>'profile_visibility','class'=>'form-control','required']) !!}
              </div>
            </div>
            <div class="row align-items-center mb-10 g-4">
              <div class="col-md-3">
            ...
            <div class="row align-items-center mb-20">
              ...
              <div class="col-md-9">
                ...
                {!! Form::select('district', [$profile->district=>$profile->district],null,
            ...
            <div class="row align-items-center mb-20">
              <div class="col-md-3">
                <label for="upazila" class="fss-18">Upazila/Thana<span>*</span></label>
              </div>
              <div class="col-md-9">
                {!! Form::select('upazila', [$profile->upazila=>$profile->upazila],null,
            ...
            <div class="row align-items-center mb-10 g-4">
              ...
              <div class="col-md-9">
                ...
                <input type="text" value="{{@$profile->address?: old('address') }}" required name="address" placeholder="Full Address">
              </div>
            </div>
